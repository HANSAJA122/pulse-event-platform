  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm glass-panel p-8 rounded-3xl relative z-10">
        <h1 className="text-2xl font-bold mb-2 font-display tracking-tight text-center">Create an account</h1>
        <p className="text-pulse-text-muted text-sm text-center mb-8">Start hosting events in seconds.</p>
